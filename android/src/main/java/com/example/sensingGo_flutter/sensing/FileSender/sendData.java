package com.example.sensingGo_flutter.sensing.FileSender;
...
public class sendData extends AsyncTask<Void, String, Integer> {
    ...
    public boolean connectSFTPServer() {
        try {
            ...
            Log.d("hostohst", "");
            mSession = jsch.getSession("", "", 22); // port 22
            mSession.setPassword("");
    ...
    protected Integer doInBackground(Void... params) {
        if (connectSFTPServer()) {
            ...
            try {
                ...
                sftpChannel.connect();
                Log.i("sender", mContext.getFilesDir().getPath().toString() + "/" + UserID_path + ".json");
                ...
                sftpChannel.put(mContext.getFilesDir().getPath().toString() + "/" + UserID_path + ".json",
                        "/home/yicchen/Desktop/" + UserID_path + cTime + ".json");
