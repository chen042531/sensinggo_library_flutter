...
//        wifiMap.put("servingIP",String.valueOf(servingIP));
//        wifiMap.put("servingSSID",String.valueOf(servingSSID));
//        wifiMap.put("servingBSSID",String.valueOf(servingBSSID));
//        wifiMap.put("servingMAC",String.valueOf(servingMAC));
//        wifiMap.put("servingLevel",String.valueOf(servingLevel));
//        return wifiMap;
    }
