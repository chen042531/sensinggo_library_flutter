...
public class CellularInfo extends PhoneStateListener {
    ...
    public void onSignalStrengthsChanged(final android.telephony.SignalStrength signalstrength) {
        ...
        CellularMap.put("cellInfoType",String.valueOf(CellularInfo.cellInfoType));
        CellularMap.put("PreAtCellID",String.valueOf(CellularInfo.PreAtCellID));
        //LTE
        CellularMap.put("lteCellRSRP",String.valueOf(CellularInfo.lteCellRSRP));
        CellularMap.put("lteCellID",String.valueOf(CellularInfo.lteCellID));
        CellularMap.put("lteCellMCC",String.valueOf(CellularInfo.lteCellMCC));
        CellularMap.put("lteCellMNC",String.valueOf(CellularInfo.lteCellMNC));
        CellularMap.put("lteCellPCI",String.valueOf(CellularInfo.lteCellPCI));
        CellularMap.put("lteCellTAC",String.valueOf(CellularInfo.lteCellTAC));
        CellularMap.put("lteCellRSRQ",String.valueOf(CellularInfo.lteCellRSRQ));
        CellularMap.put("lteCellRSSNR",String.valueOf(CellularInfo.lteCellRSSNR));
        CellularMap.put("cellTimeInterval",String.valueOf(CellularInfo.cellTimeInterval));


        //wcdma
        CellularMap.put("wcdmaAtCellPsc",String.valueOf(CellularInfo.wcdmaAtCellPsc));
        CellularMap.put("wcdmaAtCellLac",String.valueOf(CellularInfo.wcdmaAtCellLac));
        CellularMap.put("wcdmaAtCellID",String.valueOf(CellularInfo.wcdmaAtCellID));
        CellularMap.put("wcdmaAtCellMCC",String.valueOf(CellularInfo.wcdmaAtCellMCC));
        CellularMap.put("wcdmaAtCellMNC",String.valueOf(CellularInfo.wcdmaAtCellMNC));
        CellularMap.put("wcdmaAtCellSignalStrength",String.valueOf(CellularInfo.wcdmaAtCellSignalStrength));
        CellularMap.put("passCellNum",String.valueOf(CellularInfo.passCellNum));
        CellularMap.put("nowCellID",String.valueOf(CellularInfo.nowCellID));
        CellularMap.put("stayCellAt",String.valueOf(CellularInfo.stayCellAt));
        CellularMap.put("cellHoldTime",String.valueOf(CellularInfo.cellHoldTime));
        CellularMap.put("avgCellResidenceTime",String.valueOf(CellularInfo.avgCellResidenceTime));
        CellularMap.put("avgCellHoldTime",String.valueOf(CellularInfo.avgCellHoldTime));
        CellularMap.put("ttlCellResidenceTime",String.valueOf(CellularInfo.ttlCellResidenceTime));
        eve.success(CellularMap);
